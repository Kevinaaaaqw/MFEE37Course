...
function Ng(s) {
  ...
  return t === "[object RegExp]" || t === "[object Date]" || Hg(s);
}
var Rg = typeof Symbol == "function" && Symbol.for, Pg = Rg ? Symbol.for("react.element") : 60103;
function Hg(s) {
  return s.$$typeof === Pg;
}
function Bg(s) {
...
function _i(s, t) {
  return t.clone !== !1 && t.isMergeableObject(s) ? We(Bg(s), s, t) : s;
}
function Vg(s, t, e) {
...
function ma(s) {
  return Object.keys(s).concat(Fg(s));
}
function Vl(s, t) {
  try {
    return t in s;
...
function jg(s, t, e) {
  ...
  return e.isMergeableObject(s) && ma(s).forEach(function(n) {
    ...
    Yg(s, n) || (Vl(s, n) && e.isMergeableObject(t[n]) ? i[n] = Wg(n, e)(s[n], t[n], e) : i[n] = _i(t[n], e));
  }), i;
}
function We(s, t, e) {
  e = e || {}, e.arrayMerge = e.arrayMerge || Vg, e.isMergeableObject = e.isMergeableObject || Lg, e.cloneUnlessOtherwiseSpecified = _i;
  var i = Array.isArray(t), n = Array.isArray(s), o = i === n;
  return o ? i ? e.arrayMerge(s, t, e) : jg(s, t, e) : _i(t, e);
}
We.all = function(t, e) {
  if (!Array.isArray(t))
...
var Kg = We, Ug = Kg;
const zn = /* @__PURE__ */ $g(Ug), ga = "chart", is = "te.chart", zg = "chart", ba = (s, t, e) => {
  const i = (n, o, r) => {
    const a = n.slice();
...
class Wl {
  ...
  async _waitForCharts(t, e, i = {}, n = {}) {
    this._Chartjs = await this._getChartjs(), this._ChartDataLabels = await this._getChartDataLabels(), this._element = t, this._data = e, this._options = i, this._type = e.type, this._canvas = null, this._chart = null, this._darkOptions = this._getDarkConfig(n), this._darkModeClassContainer = document.querySelector("html"), this._prevConfig = null, this._observer = null, this._element && (I.setData(t, is, this), p.addClass(this._element, zg), this._chartConstructor()), this._darkOptions.darkmodeOff !== null && (this._handleMode(this.systemColorMode), this._observer = new MutationObserver(this._observerCallback.bind(this)), this._observer.observe(this._darkModeClassContainer, {
      attributes: !0
    }));
  }
  // Getters
